...
<div class="content">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
				<div class="card-header text-center "><a class="navbar-brand" href="{{ url('/') }}">
                   <img src="images/lgimsicon.png" width="75" height=auto class="img-fluid align-middle " alt="">
                </a><h5 class="text-center d-inline">Local Government Information Management Systems</h5></div>
